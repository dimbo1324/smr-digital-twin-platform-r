...
func (s *Server) routes() http.Handler {
	...
	mux.Handle("GET /api/v1/alarms", s.handlers.Alarms)
	mux.Handle("GET /api/v1/alarms/active", s.handlers.ActiveAlarms)
	mux.Handle("GET /api/v1/alarms/events", s.handlers.AlarmEvents)
	mux.Handle("GET /api/v1/alarms/{alarmId}", s.handlers.AlarmDetails)

...
const badgeVariants = cva(
  "inline-flex w-fit max-w-full min-w-0 items-center gap-1.5 rounded-full border px-2.5 py-1 text-left text-xs font-medium leading-snug transition-colors break-normal",
  {
    variants: {
      variant: {

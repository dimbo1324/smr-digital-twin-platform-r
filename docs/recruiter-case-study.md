...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Frontend HMI               | React HMI with dashboard, process mnemonic, trends, reports, settings, scenario authoring, three themes, and compact HMI density | Shows user-facing industrial workflow and responsive UI discipline.                                      |
